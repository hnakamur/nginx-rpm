...
Source114: https://github.com/openresty/set-misc-nginx-module/archive/master.tar.gz#/set-misc-nginx-module-master.tar.gz
...
./configure \
        ...
        --add-dynamic-module=./set-misc-nginx-module-master \
        --with-debug \
